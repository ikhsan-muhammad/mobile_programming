...
public class Tugas7Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_proses.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				// Menampilkan Alert
				AlertDialog.Builder validasi_radio = new AlertDialog.Builder(Tugas7Activity.this);
...
//		super.onBackPressed();
		...
		validasi_radio.setPositiveButton("Home", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				// TODO Auto-generated method stub
				Intent pindah7 = new Intent(Tugas7Activity.this, General.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tugas_soal_aftr_ut, menu);
		return true;
	}
