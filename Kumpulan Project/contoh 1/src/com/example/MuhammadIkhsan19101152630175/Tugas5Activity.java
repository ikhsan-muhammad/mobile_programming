...
public class Tugas5Activity extends Activity {
	RadioGroup rg;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//tahap 2 list view
//		ArrayAdapter<String>atur_list = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,jenis_karkas);
//		ls.setAdapter(atur_list);
		...
		cek1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				AlertDialog.Builder validasi_radio = new AlertDialog.Builder(Tugas5Activity.this);
		...
		cek2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				// menampilkan form validasi pilihan radio
				AlertDialog.Builder validasi_cek = new AlertDialog.Builder(Tugas5Activity.this);
		...
		ls.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v, int position,
				...
				jk = pilihan_list;
				AlertDialog.Builder hasil_pilihan = new AlertDialog.Builder(Tugas5Activity.this);
...
//		super.onBackPressed();
		...
		validasi_radio.setPositiveButton("Home", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				// TODO Auto-generated method stub
				Intent pindah5 = new Intent(Tugas5Activity.this, General.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tugas5, menu);
		return true;
	}
