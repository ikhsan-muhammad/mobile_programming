...
public class Page1Activity extends TabActivity {
	TabHost tab_menu;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		ts1.setIndicator("Data Pengunjung Pustaka");
		ts1.setContent(new Intent(this, Page2Activity.class));
		tab_menu.addTab(ts1);
		
		TabSpec ts2 = tab_menu.newTabSpec("Page 2");
		ts2.setIndicator("About Android");
		ts2.setContent(new Intent(this, Page2Activity.class));
		tab_menu.addTab(ts2);
	}
