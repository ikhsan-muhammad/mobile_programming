...
//		super.onBackPressed();
		AlertDialog.Builder validasi_radio = new AlertDialog.Builder(Project4Activity.this);
		...
		validasi_radio.setPositiveButton("Home", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				// TODO Auto-generated method stub
				Intent pindah2 = new Intent(Project4Activity.this, General.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.project4, menu);
		return true;
	}
